...
class Room:
    ...
    def __str__(self) -> str:
        ...
        for idx in range(4):
            ...
            elif self._doors[idx] > 0:              
                if self._doors[idx] == 2:
    ...
    def update(self):
        ...
        for idx in range(4):
            if self.nexLoc[idx] in LOCATIONS.val.keys():
                ...
                if otherDoor == 2:
                    if self._doors[idx] == 0:
                        self._doors[idx] = 3
                    elif self._doors[idx] == 1:
                        self._doors[idx] = 2
                        OPENINGS.val -= 1
